...
@ApplicationScoped
public class TenisFileServiceImpl implements FileService{
    ...
    public void upload(Long id, String nomeImagem, byte[] imagem) {
        ...
        try {
            tenis.setNomeImagem(salvarImagem(nomeImagem, imagem));
        } catch (IOException e) {
    ...
    public String verificarExtensao(String nomeImagem) throws IOException{
        System.out.println("Nome da imagem recebido: " + nomeImagem);
        String mimeType =  Files.probeContentType(new File(nomeImagem).toPath());
        List<String> listMimeType = Arrays.asList("image/jpg", "image/gif", "image/png", "image/jpeg");
        System.out.println("Tipo da imagem recebido: " + mimeType);
