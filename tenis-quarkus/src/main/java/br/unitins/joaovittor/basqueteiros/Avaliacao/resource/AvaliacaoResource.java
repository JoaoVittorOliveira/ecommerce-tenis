package br.unitins.joaovittor.basqueteiros.Avaliacao.resource;
...
import br.unitins.joaovittor.basqueteiros.Avaliacao.service.AvaliacaoService;
...
public class AvaliacaoResource {
    ...
    @Inject
    public AvaliacaoService service;
    ...
    @GET
    @Path("/search/comentario/{comentario}")
    public Response findByComentario( @PathParam("comentario") String comentario){
        LOG.infof("Executando o metodo findByComentario. Comentario: %s", comentario);
        return Response.ok(service.findByComentario(comentario)).build();
    }
